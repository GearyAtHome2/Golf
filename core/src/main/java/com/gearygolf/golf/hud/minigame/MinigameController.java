...
import com.gearygolf.golf.hud.MinigameUI;
import com.gearygolf.golf.hud.ModAnimation;
import com.gearygolf.golf.hud.renderer.NotificationManager;
...
public class MinigameController {
    ...
    public void updateAndDraw(float delta, Camera camera, Terrain terrain, Vector2 spinDot,
                              ...
                              com.gearygolf.golf.ball.ShotController shotController) {
    ...
    private void stopNeedle(Vector2 currentSpin, com.gearygolf.golf.ball.ShotController shotController) {
        needleStopped = true;
        glowTimer = 1.0f;
