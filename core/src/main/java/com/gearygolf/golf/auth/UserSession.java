...
public class UserSession {
    ...
    /** True if the stored ID token has passed its 1-hour expiry (with a 60-second early buffer). */
    public boolean isIdTokenExpired() {
        return idTokenExpiry > 0 && System.currentTimeMillis() > idTokenExpiry - 60_000L;
    }
