...
public enum Club {
    ...
    DRIVER  ("Driver",         10.5f, 52.5f,  1.9f,  0.6f, 0.75f),  // ~360  (35.0 × 1.50)
    WOOD_3  ("3 Wood",         15.0f, 45.0f,  1.7f,  0.4f, 0.75f),  // ~335  (30.0 × 1.50)
    IRON_2  ("2 Iron",         14.5f, 39.6f,  1.9f,  0.1f, 1.00f),  // ~300  (26.4 × 1.50)
    WOOD_5  ("5 Wood",         18.0f, 38.25f, 1.65f, 0.3f, 0.75f),  // ~300  (25.5 × 1.50)
    IRON_3  ("3 Iron",         20.0f, 33.0f,  1.75f, 0.1f, 1.00f),  // ~275  (22.0 × 1.50)
    HYBRID_3("3 Hybrid",       21.0f, 31.5f,  1.60f, 0.3f, 0.85f),  // ~265  (21.0 × 1.50)
    IRON_4  ("4 Iron",         24.0f, 29.25f, 1.6f,  0.0f, 1.00f),  // ~260  (19.5 × 1.50)
    IRON_5  ("5 Iron",         27.0f, 26.75f, 1.4f,  0.0f, 1.00f),  // ~245  (21.4 × 1.25)
    IRON_6  ("6 Iron",         31.0f, 24.875f,1.3f,  0.0f, 1.00f),  // ~228  (19.9 × 1.25)
    IRON_7  ("7 Iron",         35.0f, 23.1f,  1.2f,  0.0f, 1.00f),  // ~208  (21.0 × 1.10)
    IRON_8  ("8 Iron",         39.0f, 20.79f, 1.1f,  0.0f, 1.00f),  // ~188  (18.9 × 1.10)
    IRON_9  ("9 Iron",         43.0f, 18.7f,  1.0f,  0.0f, 1.00f),  // ~165  (17.0 × 1.10)
    PWEDGE  ("Pitching Wedge", 46.0f, 16.0f,  0.9f,  0.0f, 0.90f),  // ~145  (unchanged)
    GWEDGE  ("Gap Wedge",      50.0f, 14.5f,  0.85f, 0.0f, 0.85f),  // ~125  (unchanged)
    SWEDGE  ("Sand Wedge",     54.0f, 13.0f,  0.8f,  0.0f, 0.80f),  // ~105  (unchanged)
    LWEDGE  ("Lob Wedge",      58.0f, 11.5f,  0.9f,  0.0f, 0.77f),  // ~88   (unchanged)
