...
public enum Club {
    ...
    DRIVER  ("Driver",         10.5f, 49.0f,  1.9f,  0.6f, 0.75f,  2.0f),  // ~360  (32.7 × 1.50)
    WOOD_3  ("3 Wood",         15.0f, 42.3f,  1.7f,  0.4f, 0.75f,  0.5f),  // ~340  (28.2 × 1.50)
    IRON_2  ("2 Iron",         14.5f, 35.7f,  1.9f,  0.1f, 1.00f, -1.5f),  // ~300  (23.8 × 1.50)
    WOOD_5  ("5 Wood",         18.0f, 34.7f,  1.65f, 0.3f, 0.75f, -1.5f),  // ~300  (23.1 × 1.50)
    IRON_3  ("3 Iron",         20.0f, 30.7f,  1.75f, 0.1f, 1.00f, -2.0f),  // ~283  (20.5 × 1.50)
    HYBRID_3("3 Hybrid",       21.0f, 30.9f,  1.60f, 0.3f, 0.85f, -2.0f),  // ~283 carry, more rollout than 3i (spinMult 0.85)
    IRON_4  ("4 Iron",         24.0f, 28.0f,  1.6f,  0.0f, 1.00f, -2.5f),  // ~267  (18.7 × 1.50)
    IRON_5  ("5 Iron",         27.0f, 26.0f,  1.4f,  0.0f, 1.00f, -3.0f),  // ~250  (20.8 × 1.25)
    IRON_6  ("6 Iron",         31.0f, 24.6f,  1.3f,  0.0f, 1.00f, -3.5f),  // ~236  (19.7 × 1.25)
