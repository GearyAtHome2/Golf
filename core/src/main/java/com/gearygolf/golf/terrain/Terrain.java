...
import com.gearygolf.golf.terrain.features.PuttingGreenGenerator;
import com.gearygolf.golf.terrain.objects.Monolith;
import com.gearygolf.golf.terrain.objects.TerrainObject;
...
public class Terrain {
    ...
    public void updateFlag(Vector3 cameraPosition, Vector3 ballPosition) {
        ...
        float scale = 1.0f + (float) Math.sqrt(distFactor) * 0.15f * com.gearygolf.golf.hud.HUD.UI_SCALE;
