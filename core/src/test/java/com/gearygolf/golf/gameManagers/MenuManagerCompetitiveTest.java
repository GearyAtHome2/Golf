...
import com.gearygolf.golf.GdxTestSetup;
...
public class MenuManagerCompetitiveTest {
    ...
    private static class TrackingMenuHandler implements MenuManager.MenuHandler {
        ...
        @Override public void onStartWithArchetype(com.gearygolf.golf.terrain.level.LevelData.Archetype archetype) { lastCalled = "archetype"; }
    }
