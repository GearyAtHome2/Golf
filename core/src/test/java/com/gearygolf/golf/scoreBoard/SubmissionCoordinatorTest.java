...
public class SubmissionCoordinatorTest {
    ...
    public void isSubmissionInProgress_falseOnConstruction() {
        ...
        SubmissionCoordinator coordinator = new SubmissionCoordinator(
                null, null, null, new DailySubmissionCache(), null, NO_OP_CALLBACKS);
        assertFalse(coordinator.isSubmissionInProgress());
    }

    @Test
    public void isSubmissionInProgress_independentInstances() {
        SubmissionCoordinator a = new SubmissionCoordinator(null, null, null, new DailySubmissionCache(), null, NO_OP_CALLBACKS);
        SubmissionCoordinator b = new SubmissionCoordinator(null, null, null, new DailySubmissionCache(), null, NO_OP_CALLBACKS);
